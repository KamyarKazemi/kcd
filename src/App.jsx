      ...
      <div className="w-full h-full overflow-y-auto scrollbar-hide">
        ...
        <section className="relative min-h-screen flex items-center justify-center parchment overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-8 text-center">
            ...
            >
              <h1 className="text-7xl md:text-8xl font-bold mb-6 text-amber-100 font-serif drop-shadow-lg">
                KINGDOM COME
              </h1>
              <p className="text-3xl md:text-4xl text-amber-600 mb-8 tracking-widest font-serif">
                Deliverance
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg md:text-xl text-stone-300 leading-relaxed font-serif">
            ...
            >
              ...
              <p className="text-stone-500 text-sm mt-2 tracking-wider font-serif">
                DISCOVER THE TALES
              </p>
            </motion.div>
        ...
        <section className="relative min-h-screen py-20 px-4 bg-linear-to-b from-stone-900 via-stone-950 to-black">
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-5xl font-bold text-center mb-4 text-amber-100 font-serif"
            >
            ...
            <motion.p
              ...
              className="text-center text-stone-400 mb-16 text-lg font-serif"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {CHARACTERS.map((char, idx) => (
                <motion.div
                  ...
                  className={`relative cursor-pointer group bg-linear-to-br ${char.theme} p-6 border-2 border-amber-700/40 rounded-sm overflow-hidden`}
                  ...
                  <div className="relative h-full flex flex-col justify-between">
                    ...
                    <div className="flex-1 flex items-center justify-center mb-4">
                      <div className="relative w-32 h-32 border-2 border-amber-700/40 rounded-full bg-stone-950/50 flex items-center justify-center group-hover:border-amber-600/60 transition-colors">
                        <span
                          className={`text-6xl font-bold ${char.textColor} opacity-40 font-serif`}
                        >
                          {char.name.charAt(0)}
                        </span>
                      </div>
                    ...
                    <div className="text-center space-y-2">
                      <h3
                        className={`text-2xl font-bold ${char.textColor} font-serif`}
                      >
                        {char.name}
                      </h3>
                      <p className="text-stone-400 text-sm tracking-wide font-serif">
                        {char.title}
                      </p>
                      <div className="w-16 h-px bg-amber-700/40 mx-auto my-3" />
                      <p className="text-stone-300 text-sm italic leading-relaxed px-2 font-serif">
                        "{char.quote}"
                      </p>
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        className="mt-4 px-6 py-2 bg-amber-600/20 border border-amber-600/40 text-amber-200 text-sm tracking-wider hover:bg-amber-600/30 transition-colors font-serif"
                      >
                        READ MORE
                      </motion.button>
                    </div>
          ...
          >
            ...
            >
              {(() => {
                ...
                return (
                  <div
                    className={`relative bg-linear-to-br ${char.theme} p-8 md:p-12 border-4 border-amber-700/40 rounded-sm`}
                  >
                    {/* Close Button */}
                    <button
                      onClick={() => setExpandedCard(null)}
                    ...
                    <div className="text-center mb-8">
                      ...
                      <h2
                        className={`text-5xl font-bold ${char.textColor} mb-2 font-serif`}
                      >
                        {char.name}
                      </h2>
                      <p className="text-stone-400 text-xl tracking-wide font-serif">
                        {char.title}
                      </p>
                    ...
                    <div className="max-w-none">
                      {char.story.split("\n\n").map((paragraph, idx) => (
                        <motion.p
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          transition={{ delay: idx * 0.1 }}
                          className="text-stone-300 text-lg leading-relaxed mb-6 font-serif"
                        >
                          {paragraph}
                        </motion.p>
                      ))}
